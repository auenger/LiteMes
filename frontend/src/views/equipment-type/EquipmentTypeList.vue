  ...
  <div class="equipment-type-page">
    <div class="page-header">
      ...
      <div class="header-actions">
        ...
        <button class="btn btn-primary" @click="openCreateDialog">新建设备类型</button>
      </div>
    </div>
    ...
    <div v-if="dialogVisible" class="dialog-overlay" @click.self="closeDialog">
      <div class="dialog">
        <div class="dialog-header">
          <h3>{{ isEdit ? '编辑设备类型' : '新建设备类型' }}</h3>
          <button class="dialog-close" @click="closeDialog">&times;</button>
        </div>
        <div class="dialog-body">
          <div class="form-group">
            <label>设备类型编码 <span class="required">*</span></label>
            <input
    ...
    <div v-if="deleteDialogVisible" class="dialog-overlay" @click.self="closeDeleteDialog">
      <div class="dialog dialog-sm">
        ...
        <div class="dialog-body">
          ...
          <p class="text-muted">已被设备型号引用的类型不可删除。删除后不可恢复。</p>
        </div>
        <div class="dialog-footer">
