...
- **Merged Branch**: feature/feat-equipment-model
- **Merge Commit**: ffc9384
- **Archive Tag**: feat-equipment-model-20260422
- **Conflicts**: none
- **Verification**: passed (20/20 tests)
- **Stats**: 19 files changed, 2034 insertions, 6 deletions, 1 commit
