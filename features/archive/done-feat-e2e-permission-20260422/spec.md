...
- **Merged Branch**: feature/e2e-permission
- **Merge Commit**: cd34ed2
- **Archive Tag**: feat-e2e-permission-20260422
- **Conflicts**: None
- **Verification**: 10/10 Playwright E2E tests passed
- **Bug Fixes**: Fixed UserDataPermissionList.vue (group.name + user.userId)
- **Duration**: ~45 minutes
