...
- **Branch**: feature/feat-company
- **Merge Commit**: d8efc0c
- **Archive Tag**: feat-company-20260422
- **Conflicts**: Yes (2 files: frontend/src/router/index.ts, src/main/resources/db/schema.sql) -- resolved by keeping both parallel additions
- **Verification**: passed (7/8 Gherkin scenarios, 1 deferred for feat-factory)
- **Stats**: 2 commits, 19 files changed, 1570 insertions
