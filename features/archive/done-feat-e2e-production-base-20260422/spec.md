...
- **Branch**: feature/e2e-production-base (deleted)
- **Merge Commit**: 2d14aa7
- **Archive Tag**: feat-e2e-production-base-20260422
- **Conflicts**: None
- **Verification**: 13/13 E2E tests passed (work-center: 5, uom: 5, uom-conversion: 3)
- **Bug Fix**: Added missing `isColumnVisible` function in WorkCenterList.vue
- **Files Changed**: 4 files (3 new E2E specs + 1 bug fix)
