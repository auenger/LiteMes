...
- **Merged Branch**: feature/feat-uom
- **Merge Commit**: 10aac4c
- **Archive Tag**: feat-uom-20260422
- **Conflicts**: Yes (5 files: dropdown.ts, router/index.ts, DropdownService.java, DropdownResource.java, import.sql) -- all resolved by keeping both parallel additions from feat-material-category and feat-uom
- **Verification**: 22/22 tests passed, all 4 Gherkin scenarios satisfied
- **Deferred Items**: Excel import/export, AuditLog integration
- **Stats**: 31 files changed, 3374 insertions, 1 commit
