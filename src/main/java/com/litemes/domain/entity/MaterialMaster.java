...
/**
 * MaterialMaster entity.
 * Represents a material in PCB manufacturing.
 * Material code is immutable after creation.
 * Supports version management via MaterialVersion.
 */
@TableName("material_master")
public class MaterialMaster extends SoftDeleteEntity {
