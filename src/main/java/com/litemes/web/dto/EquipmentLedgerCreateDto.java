...
/**
 * DTO for creating an equipment ledger entry.
 * Equipment code is required and immutable after creation.
 * Equipment model, factory, running status, manage status, and commissioning date are required.
 */
public class EquipmentLedgerCreateDto {
